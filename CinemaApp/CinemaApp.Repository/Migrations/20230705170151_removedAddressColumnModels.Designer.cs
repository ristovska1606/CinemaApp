...
namespace CinemaApp.Repository.Migrations
{
    ...
    [Migration("20230705170151_removedAddressColumnModels")]
    partial class removedAddressColumnModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaApp.Domain.IdentityModel.CinemaAppUser", b =>
                {
            ...
            modelBuilder.Entity("CinemaApp.Domain.Relationships.TicketInOrder", b =>
                {
            ...
            modelBuilder.Entity("CinemaApp.Domain.Relationships.TicketInShoppingCart", b =>
                {
                    b.Property<Guid>("TicketId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CinemaApp.Domain.DomainModels.Order", b =>
                {
                    b.HasOne("CinemaApp.Domain.IdentityModel.CinemaAppUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaApp.Domain.Relationships.TicketInOrder", b =>
                {
                    b.HasOne("CinemaApp.Domain.DomainModels.Order", "UserOrder")
                        .WithMany("TicketsInOrder")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CinemaApp.Domain.DomainModels.Ticket", "Ticket")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CinemaApp.Domain.IdentityModel.CinemaAppUser", null)
                        .WithMany()
